...
class IFStageII(IFBaseModule):
    ...
    def __init__(self, *args, model_kwargs=None, pil_img_size=256, **kwargs):
        ...
        self.inCh = model_params['in_channels']  # may be 39
        self.outCh = model_params['out_channels']
        ...
        model_params['channel_mult'] = channel_mult
        with accelerate.init_empty_weights():
            self.model = SuperResUNetModel(low_res_diffusion=self.get_diffusion('1000'), **model_params)
        self.model = self.load_checkpoint(self.model, self.dir_or_name, filename=self.filename)
    ...
    def embeddings_to_image(
            ...
            progress=True, seed=None, sample_fn=None, hint=None, **kwargs):
